...
function overviewHelp() {
  const lines = [
    ...
    "",
    "Before building, get two facts from the user (or the repo): the",
    "website's address, and which tool renders the form. `converly status`",
    "tells you what's missing and what to run next at every point.",
    "",
    ...
    "  converly triggers connect typeform --site <site> # ONLY for providers whose setup says requires_connection",
